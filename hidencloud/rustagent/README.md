...
The compiled binary is at `target/release/hidencloud-agent.exe`.

## Configuration

The builder in the HidenCloud panel generates a customized `main.rs` with:
